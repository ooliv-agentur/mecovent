    ...
    <section id="projects" className="relative overflow-hidden w-full bg-white" ref={sectionRef}>
      <div className="py-16 md:py-24">
        <div className={cn("text-center max-w-3xl mx-auto px-4 mb-12", 
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 tracking-tight bg-gradient-to-r from-white to-[#009fe3] bg-clip-text text-transparent bg-200% animate-gradient-shift leading-[1.6] break-words text-shadow">
